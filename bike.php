      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Bike <i class="ion-ios-arrow-forward"></i></span></p>
...
?>		
    			<div class="col-md-4">			
    				<div class="car-wrap rounded ftco-animate">						
    					...
    					<div class="text">
    						<h2 class="mb-0"><a href="car-single.html"><?php echo $row['bike_name']; ?></a></h2>
    						<div class="d-flex mb-3">
	    						<p class="price ml-auto">$<?php echo $row['bike_price']; ?> <span>/day</span></p>
    						</div>
    						<p class="d-flex mb-0 d-block"><a href="bikedetail.php?id=<?php echo $row['bike_id']; ?>" class="btn btn-primary py-2 mr-1">View More</a> </p>
    					</div>
    				</div>
    			</div>
				<?php
